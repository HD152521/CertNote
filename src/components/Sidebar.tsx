...
interface SidebarProps { certTrees: { meta: CertMeta; days: DayRef[] }[]; }

export function Sidebar({ certTrees }: SidebarProps) {
  ...
  function toggle(slug: string) { setOpenSlugs((p) => ({ ...p, [slug]: !p[slug] })); }
  return (
